...
mod tests {
    ...
    fn no_wrap_short_line() {
        ...
        let wm = WrapMap::new(&lines, 80, &MonospaceWidth);
    ...
    fn wrap_at_word_boundary() {
        ...
        let wm = WrapMap::new(&lines, 7, &MonospaceWidth);
    ...
    fn wrap_hard_break_no_space() {
        ...
        let wm = WrapMap::new(&lines, 5, &MonospaceWidth);
        assert_eq!(wm.total_screen_rows(), 2);
        assert_eq!(wm.screen_row_to_line(0), Some((0, 0, 0)));
    ...
    fn multiple_lines() {
        ...
        let wm = WrapMap::new(&lines, 10, &MonospaceWidth);
    ...
    fn cjk_characters() {
        ...
        let wm = WrapMap::new(&lines, 6, &MonospaceWidth);
    ...
    fn whitespace_only_line() {
        let lines = [make_line("     ")];
        let wm = WrapMap::new(&lines, 3, &MonospaceWidth);
        assert_eq!(wm.total_screen_rows(), 2);
    }
